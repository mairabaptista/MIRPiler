...
{
       0,    47,    47,    78,    90,    92,    93,    95,   101,   110,
     112,   117,   123,   133,   134,   136,   148,   150,   155,   163,
     170,   182,   184,   196,   198,   199,   200,   201,   202,   204,
     205,   207,   213,   222,   229,   233,   240,   245,   247,   252,
     256,   264,   269,   272,   276,   280,   284,   288,   292,   297,
     302,   304,   308,   314,   319,   321,   325,   331,   332,   333,
     334,   336,   343,   344,   346,   358,   360,   366
};
#endif
...
{
  "$end", "error", "$undefined", "IF", "ELSE", "WHILE", "RETURN", "GT",
  "GE", "LT", "LE", "EQ", "NEQ", "PLUS", "MINUS", "MULT", "DIV", "ASSIGN",
  "OPAREN", "CPAREN", "OBRACKET", "CBRACKET", "OCURLY", "CCURLY", "SEMI",
  "COMMA", "ERROR", "ENDFILE", "INT", "VOID", "ID", "NUM", "$accept",
  "program", "declarationList", "declaration", "var_declaration",
  ...
  "expression", "assigment_operator", "var", "simple_expression", "relop",
  "additive_expression", "addop", "term", "mulop", "factor", "call",
  "args", "arg_list", "id", "num", YY_NULLPTR
};
#endif
...
{
      16,   -59,   -59,   -59,     8,     3,   -59,   -59,   -17,   -59,
     -59,   -59,   -59,    52,    19,   -15,   -59,    -1,   -17,     2,
      -2,   -59,   -59,     4,    29,    32,    61,    42,    35,   -59,
     -59,   -59,   -59,   -59,     6,   -59,   -17,    37,   -14,    55,
      80,    33,    44,   -59,   -59,   -59,   -59,   -59,   -59,   -59,
     -59,    76,    75,   -59,    72,    79,   -59,   -59,    81,   -59,
      44,    44,   -59,    78,    84,   -59,   -59,    44,    44,   -59,
     -59,   -59,   -59,   -59,   -59,   -59,   -59,    44,    44,   -59,
     -59,    44,    44,    85,    86,   -59,   -59,   -59,    87,    74,
     -59,    89,    83,    79,   -59,    88,    47,    47,   -59,    44,
     -59,   104,   -59,   -59,    47,   -59
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       1,     3,    66,     0,     0,     0,     7,    11,     0,     0,
      13,    16,    67,     0,    17,     0,     0,     0,     0,    21,
      12,    15,     8,    18,     0,    20,     0,     0,     0,     0,
       0,     0,     0,    19,    30,    25,    22,    24,    26,    27,
      28,     0,    58,    37,    42,    50,    54,    59,    39,    60,
       0,     0,    34,     0,     0,    29,    38,    63,     0,    43,
      45,    44,    46,    47,    48,    51,    52,     0,     0,    55,
      56,     0,     0,     0,     0,    35,    57,    65,     0,    62,
      36,    58,    41,    49,    53,     0,     0,     0,    61,     0,
      40,    31,    33,    64,     0,    32
};
...
{
     -59,   -59,   -59,   105,    77,   -12,   -59,   -59,   -59,    90,
      92,   -59,   -59,   -58,   -59,   -59,   -59,   -59,   -41,   -59,
      10,   -59,   -59,    36,   -59,    34,   -59,    38,   -59,   -59,
     -59,    -3,    99
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      45,    34,    37,    46,    47,    48,    49,    50,    51,    68,
      52,    53,    77,    54,    78,    55,    81,    56,    57,    88,
      89,    58,    59
};
...
{
      63,    64,    18,    -2,     1,    13,    15,     1,    10,   -23,
      16,   -23,   -23,    12,    18,    24,    22,     1,   -14,    83,
      84,    25,    36,    26,   -23,    27,    87,    90,   -23,   -23,
     -23,     2,     3,    38,     2,     3,   -23,   -23,   101,   102,
      39,    95,    40,    41,     2,     3,   105,     2,    17,    28,
      39,    42,    40,    41,    29,    42,    33,    62,   103,    29,
      43,    44,    42,    12,    22,    42,    32,    12,    22,    29,
      14,    44,    15,    60,    12,    22,    16,    12,    22,    69,
      70,    71,    72,    73,    74,    75,    76,    91,    91,     2,
       3,    91,    66,    67,    79,    80,    75,    76,    61,    99,
      65,    82,    85,    86,    96,    97,    98,    67,   104,   100,
      11,    35,    93,    92,    23,     0,    31,    30,     0,    94
};

static const yytype_int8 yycheck[] =
{
      41,    42,    14,     0,     1,     8,    20,     1,     0,     3,
      24,     5,     6,    30,    26,    18,    31,     1,    19,    60,
      61,    19,    34,    25,    18,    21,    67,    68,    22,    23,
      24,    28,    29,    36,    28,    29,    30,    31,    96,    97,
       3,    82,     5,     6,    28,    29,   104,    28,    29,    20,
       3,    18,     5,     6,    22,    18,    21,    24,    99,    22,
      23,    24,    18,    30,    31,    18,    24,    30,    31,    22,
      18,    24,    20,    18,    30,    31,    24,    30,    31,     7,
       8,     9,    10,    11,    12,    13,    14,    77,    78,    28,
      29,    81,    17,    18,    15,    16,    13,    14,    18,    25,
      24,    20,    24,    19,    19,    19,    19,    18,     4,    21,
       5,    34,    78,    77,    15,    -1,    26,    25,    -1,    81
};
...
{
       0,     1,    28,    29,    33,    34,    35,    36,    37,    38,
       0,    35,    30,    63,    18,    20,    24,    29,    37,    39,
      40,    41,    31,    64,    63,    19,    25,    21,    20,    22,
      42,    41,    24,    21,    43,    36,    37,    44,    63,     3,
       5,     6,    18,    23,    24,    42,    45,    46,    47,    48,
      49,    50,    52,    53,    55,    57,    59,    60,    63,    64,
      18,    18,    24,    50,    50,    24,    17,    18,    51,     7,
       8,     9,    10,    11,    12,    13,    14,    54,    56,    15,
      16,    58,    20,    50,    50,    24,    19,    50,    61,    62,
      50,    52,    55,    57,    59,    50,    19,    19,    19,    25,
      21,    45,    45,    50,     4,    45
};
...
#line 47 "cminus.y" /* yacc.c:1646  */
    {
                    ...
                    insertNewNode(createSysCall(VoidType, RecoverOs));      //recover OS
...
#line 95 "cminus.y" /* yacc.c:1646  */
    {
                    ...
                    (yyval)->child[0]->kind.decl.mem = Locals;
                }
...
#line 101 "cminus.y" /* yacc.c:1646  */
    {
                    ...
                    (yyval)->child[0]->type = (yyval)->type;
                    (yyval)->child[0]->kind.decl.mem = Locals;
                    (yyval)->child[0]->kind.decl.declkind = Array;
                    (yyval)->child[0]->child[0] = (yyvsp[-2]);
                    (yyval)->child[0]->child[0]->type = IntegerType;
                }
...
#line 123 "cminus.y" /* yacc.c:1646  */
    {
                    ...
                    (yyval)->child[0] = (yyvsp[-4]);
                    (yyval)->child[0]->type = (yyval)->type;
                    (yyval)->child[0]->kind.decl.declkind = Function;
                    (yyval)->child[0]->kind.decl.mem = FunMem;
                    (yyval)->child[0]->child[0] = (yyvsp[-2]);
...
#line 150 "cminus.y" /* yacc.c:1646  */
    {
                    ...
                    (yyval)->child[0]->kind.decl.mem = Param;
                }
...
#line 257 "cminus.y" /* yacc.c:1646  */
    {
                	(yyval) = (yyvsp[-3]);
                	(yyval)->kind.decl.declkind = Array;
                    (yyval)->kind.decl.access = Access;
                	(yyval)->child[0] = (yyvsp[-1]);
                }
...
#line 360 "cminus.y" /* yacc.c:1646  */
    {
                	(yyval) = newVarNode(Id);
                	(yyval)->kind.decl.name = copyString(tokenString);
                    (yyval)->type = IntegerType;
                }
...
#line 366 "cminus.y" /* yacc.c:1646  */
    {
                    (yyval) = newVarNode(Const);
                    (yyval)->kind.decl.value = atoi(tokenString);
                    (yyval)->type = IntegerType;
        		}
